...
def orderlines_mapping(df_orderlines, orders_number):
	'''Mapping orders con il numero di wave '''
	df_orderlines.sort_values(by='DATE', ascending = True, inplace = True)
	# Lista dei Numeri univoci degli order
